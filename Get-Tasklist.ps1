<#
.SYNOPSIS
  The "Get-Tasklist" function is a wrapper for tasklist.exe which includes a Validate Set Attribute including options such as: "Verbose" (the Default), "Services", "DLLs", and "Apps".  
...
.NOTES
  Name:  Get-Tasklist.ps1
  Author:  Travis Logue
  Version History:  2.1 | 2020-09-06 | Initial Version
  Dependencies:  
  Notes:
  - 
...
function Get-Tasklist {
  [CmdletBinding()]
  param (
    [Parameter(HelpMessage='This "-Parameter" contains a Validate Set Attribute; to scroll through options press <tab>. DEFAULT option is "Verbose", other options are "Services","DLLs", and "Apps".')]
